...
import de.unibi.agbi.biodwh2.chebi.etl.ChEBIOntologyReconExporter;
...
public class ChEBIOntologyDataSource extends OBOFoundryOntologyDataSource {
    public static final String FILE_NAME = "chebi.obo";
    
    public ChEBIOntologyDataSource() {
        super("ChEBIOntology", FILE_NAME, License.CC_BY_4_0, "ChEBI Ontology", "CHEBI", DataVersionFormat.UNKNOWN);
    }
    ...
    public ReconExporter<? extends DataSource> getReconExporter() {
        return new ChEBIOntologyReconExporter(this);
    }
}
